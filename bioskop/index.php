...
<div id="myCarousel" class="carousel carousel-fade slide mb-6" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <img src="images/The Moon1.jpg" class="" alt="...">
      <div class="carousel-caption-wrapper"></div>
      <div class="container" >
          <div class="carousel-caption text-start">
            <h1>Yang lagi viral.</h1>
            <p class="opacity-75">Viral banget harus nonton.</p>
            <p><a class="btn btn-lg btn-primary" href="film.php">Tonton sekarang</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item text-center">
      <img src="images/20th.jpg" class="" alt="...">
      <div class="carousel-caption-wrapper"></div>
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Ini gak terlalu viral.</h1>
            <p class="opacity-75">Boleh tonton kalau mau.</p>
            <p><a class="btn btn-lg btn-primary" href="film.php">Tonton sekarang</a></p>
          </div>
        </div>
      </div>
      <div class="carousel-item text-center">
      <img src="images/indigi(panjang).jpg" class="" style="object-fit:cover" alt="...">
      <div class="carousel-caption-wrapper"></div>
        <div class="container">
          <div class="carousel-caption text-start">
            <h1>Bukan yang viral-viral.</h1>
            <p class="opacity-75">Buat kamu yang gak suka sama keviralan duniawi.</p>
            <p><a class="btn btn-lg btn-primary" href="film.php">Tonton sekarang</a></p>
          </div>
        </div>
      </div>
